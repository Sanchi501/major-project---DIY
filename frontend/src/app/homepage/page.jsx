...
const Homepage = () => {
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
          Start your journey with <span className="text-teal-500">CRAFT CO.</span>
        </h1>
        ...
        <div className="mt-7 grid gap-3 w-full sm:inline-flex">
          <a
            className="hover:shadow-lg bg-teal-500 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-500 text-white hover:bg-pink-600 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
            href="/browse-kits"
          >
            Get started
            <svg
      ...
      <div className="relative ms-4">
        <img
          ...
          src="https://media.istockphoto.com/id/821114486/photo/diy-wood-font-style-on-a-wooden-workbench-top-view-do-it-yourself-concept.jpg?s=612x612&w=0&k=20&c=mDa0f88ibMeGcYsuya-y5xsWMyPkCruFxAtlU9_iZhU="
          alt="Hero Image"
        />
  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 className="text-2xl font-bold md:text-4xl md:leading-tight text-pink-600 dark:text-white">
        Our Projects
      </h2>
    </div>
    {/* End Title */}
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLpDpzHgeWmbz1eRuu4lTPa5srxMAU0AGbog&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
            Home Decor
          </h3>
          <p className="text-xs text-pink-600 sm:text-sm lg:text-base dark:text-neutral-400">
            nhdcbhcg
          </p>
        </div>
      </div>
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaFWi9r5iLQrb1-WJ-fSBeq6KApO8H42tfcg&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://hips.hearstapps.com/hmg-prod/images/ghk060123homefeature-008-655c16d90939d.jpg"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQssA9Y5akXfrqzwlzdR8NIZWqeKZ02pjaCQ&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://i.pinimg.com/736x/97/d1/7e/97d17e86c5b0bef31914f8bf9f83ad77.jpg"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSX3s0nhBiSxHz7IuQzJY1Gkv9a32R1tpVtg&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT-ehHh5KARVDKo8Ye3g0a1JFFq5mrcekiqA&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://hips.hearstapps.com/hmg-prod/images/christmas-crafts-for-kids-craft-stick-houses-1637096395.jpeg?crop=1xw:1xh;center,top&resize=980:*"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
      ...
      <div className="hover:shadow-2xl rounded-3xl text-center">
        <img
          className="rounded-xl sm:size-48 lg:size-60 mx-auto"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTykoIrWMK5ieJlmjTo6ZhaSvREDAy_j1O5sg&s"
          alt="Avatar"
        />
        <div className="mt-2 sm:mt-4">
          <h3 className="text-sm font-medium text-teal-600 sm:text-base lg:text-lg dark:text-neutral-200">
